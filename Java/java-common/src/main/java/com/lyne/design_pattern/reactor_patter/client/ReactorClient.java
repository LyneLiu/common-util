package com.lyne.design_pattern.reactor_patter.client;
...
public class ReactorClient {
    ...
    public ReactorClient(String hostIp, int hostPort) {
        this.hostIp = hostIp;
    ...
    public void runClient() throws IOException {
        ...
        System.out.println("ReactorClient connected to host : " + hostIp + " port: " + hostPort);
